...
import { Box, Divider, Grid, TextField, Typography, Button, Link } from '@mui/material'
...
const GridsHorizontal = ({ categoryId, search, categoryName }) => {
  ...
  useEffect(() => {
    ...
    fetchProducts()
    //  }, [ page, rowsPerPage, priceSearchQuery])
  }, [searchQuery, page, rowsPerPage, priceSearchQuery])
  ...
  const columns = [
    ...
    //             cursor: 'pointer',
    //           }}
    //           onClick={() => window.open(params.row.datasheetPdfurl, '_blank')}
    //         />
    //         <Box
    //           component="img"
    //           src={'/leaf.png'}
    ...
    //             cursor: 'pointer',
    //           }}
    //           onClick={() => window.open(params.row.partDetailsPdf, '_blank')}
    //         />
    //       </Grid> */}
    //       <Grid item>
    //         <img
    ...
    //           }}
    //           onClick={() => {
    //             // window.location.href = `/product/${params.row.productId}`
    //             window.location.href = `/product/${params.row.manufacturerSlug}/${params.row.categorySlug}/${params.row.sku}`
    //           }}
    //         >
    //           {params.row.name}
  ...
  // const handleAscSort = field => {
  //   setSorting({ field, order: 'asc' })
  // }

  // const handleDescSort = field => {
...
export default GridsHorizontal
