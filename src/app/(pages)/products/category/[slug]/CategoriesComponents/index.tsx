...
const Categories = ({ categoryId, categoryName }) => {
  ...
  return (
    <>
      ...
      <div className="content-container">
        ...
        {isLayoutActive ? (
          <GridsHorizontal categoryId={categoryId} categoryName={categoryName} />
        ) : (
          <GridsVertical categoryId={categoryId} categoryName={categoryName} />
        )}
      </div>
    </>
  )
