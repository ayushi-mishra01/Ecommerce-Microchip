...
const Grids = ({ categoryId, manufacturerId1, manufacturerId2 }) => {
  ...
  const [selectedCategories, setSelectedCategories] = useState({
    [-1]: {
      table: 'Manufacturer',
      values: [Number(manufacturerId1), Number(manufacturerId2)],
    },
  })
              ...
              <Grid container spacing={1} sx={{ flexWrap: 'nowrap', paddingBottom: '4px' }}>
                {fixedCategoriesData.map(category => (
                  <Grid item key={category.id}>
                    ...
                    >
                      <Typography
                        sx={{ fontSize: '12px', fontWeight: 'bold', whiteSpace: 'nowrap' }}
                      >
                        {category.name}
                      </Typography>
                      <span>
