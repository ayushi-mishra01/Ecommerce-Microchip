...
import { Post, Project, Blog } from '../../../payload/payload-types'
...
export const Card: React.FC<{
  ...
  title?: string
  relationTo?: 'projects' | 'posts' | 'blogs'
  doc?: Project | Post | Blog
  ...
  {/* @ts-expect-error */}
  const categorySlug = hasCategories ? categories[0].title : 'uncategorized';
